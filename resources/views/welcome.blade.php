...
<body>
    ...
    <main class="main">
                            ...
                            <div class="carousel-container">
                                <div class="carousel-content">
                                    <div class="row animate__animated animate__fadeInUp justify-content-center">
                                        ...
                                        <div class="col-lg-5">
                                            <p>Sekolah memiliki fasilitas lengkap bagi siswa dalam proses belajar
                                                mereka.</p>
                                        </div>
                                        <div class="col-lg-2">
                                            <a href="">Selengkapnya ></a>
        ...
        <!-- Modal -->
        <div class="modal fade" id="lulusanModal" tabindex="-1" aria-labelledby="lulusanModalLabel"
            aria-hidden="true">
        ...
        <section id="about" class="about section">
            <div class="container">
                ...
                <ul class="nav nav-tabs justify-content-start" role="tablist" data-aos="fade-up"
                    data-aos-delay="100">
                    <li class="nav-item">
                        <a class="nav-link active" href="#day-1" role="tab"
                            data-bs-toggle="tab">Pendaftaran</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="container section-title">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">Necessitatibus eius consequatur ex aliquid fuga eum
                ...
                <div class="tab-content row justify-content-end" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
                        <div class="row justify-content-center">
                            <div class="card animate__animated animate__fadeIn" data-aos="fade-up" data-aos-delay="0"
                                tabindex="0">
                        ...
                        <div class="row justify-content-center">
                            <div class="card animate__animated animate__fadeIn" data-aos="fade-up" data-aos-delay="0"
                                ...
                                <div class="text">
                                    ...
                                    <p data-splitting="">Jadwal akademik kami, termasuk tanggal penting, liburan, dan
                                        acara sekolah. Pastikan Anda selalu mengikuti kalender kami untuk merencanakan
                                        aktivitas akademik.</p>
                                    <a data-splitting="" href="#">Detail →</a>
                                </div>
                            </div>
        ...
        <section id="achievement" class="achievement section mt-4">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>Kami merayakan berbagai pencapaian luar biasa yang diraih oleh siswa-siswa kami dalam berbagai
                    kompetisi dan kegiatan akademik serta non-akademik.</p>
            </div><!-- End Section Title -->
