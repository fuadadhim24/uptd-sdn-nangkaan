        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Ruang Kelas 1</strong> adalah awal dari perjalanan pendidikan dasar, di mana siswa kami belajar untuk mengembangkan keterampilan sosial dan akademik dasar mereka dengan penekanan pada membaca, menulis, dan berhitung.</p>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Ruang Kelas 2</strong> adalah waktu di mana siswa kami mulai mengembangkan keterampilan penulisan yang lebih kompleks, memperluas pengetahuan mereka dalam ilmu pengetahuan dan matematika, serta mulai mengeksplorasi berbagai subjek yang menarik.</p>
              <!-- <a href="#">Find out more &raquo;</a> -->
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Ruang Kelas 3</strong> adalah tahap di mana siswa kami mulai mengembangkan keterampilan kritis mereka dalam memecahkan masalah matematika dan sains, serta belajar berkolaborasi dalam proyek-proyek tim yang kreatif.</p>
              <!-- <a href="#">Find out more &raquo;</a> -->
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Ruang Kelas 4</strong> adalah tahun di mana siswa kami mulai memperdalam pemahaman mereka tentang sejarah dan budaya, mengasah keterampilan interpersonal mereka, dan mengeksplorasi minat akademik khusus mereka.</p>
              <!-- <a href="#">Find out more &raquo;</a> -->
            </div>
          </div>
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Ruang Kelas 5</strong> adalah tahun di mana siswa kami mulai mempersiapkan diri untuk transisi ke tingkat pendidikan menengah, dengan mengeksplorasi minat dan bakat mereka dalam mata pelajaran yang lebih kompleks dan mendalam.</p>
              <!-- <a href="#">Find out more &raquo;</a> -->
            </div>
          </div>
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="1" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Ruang Kelas 6</strong> adalah tahun terakhir di SD kami, di mana siswa kami menyelesaikan perjalanan dasar mereka dengan memperdalam pengetahuan akademik mereka, mempersiapkan diri untuk ujian akhir, dan mempersiapkan langkah berikutnya menuju pendidikan menengah.</p>
              <!-- <a href="#">Find out more &raquo;</a> -->
            </div>
          </div>
