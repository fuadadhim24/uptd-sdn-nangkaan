...
<head>
    ...
    <title>Daftar Prestasi - UPTD SPF SDN Nangkaan Admin</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Daftar Prestasi
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <tbody>
                                        @forelse($prestasis as $index => $prestasi)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($prestasi->photo_path)
                                                        ...
                                                        <button type="button" class="btn btn-outline-success btn-sm"
                                                            ...
                                                            data-bs-target="#photoModal{{ $prestasi->id }}">
                                                            View Photo
                                                        </button>

                                                        <!-- Photo Modal -->
                                                        <div class="modal fade" id="photoModal{{ $prestasi->id }}"
                                                            tabindex="-1"
                                                            aria-labelledby="photoModalLabel{{ $prestasi->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="photoModalLabel{{ $prestasi->id }}">
                                                                            Foto Prestasi Photo
                                                                        </h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <img src="{{ asset('storage/prestasi/' . $prestasi->photo_path) }}"
                                                                            alt="Foto Prestasi Photo"
                                                                            class="img-fluid">
                                                                    </div>
                                                ...
                                                {{-- <td>{{ $prestasi->biography }}</td> --}}
                                                <td>
                                                    <!-- Edit and Delete Buttons -->
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editGuruModal-{{ $prestasi->id }}">
                                                        Edit
                                                    </button>
                                            ...
                                            <!-- Edit Guru Modal -->
                                            <div class="modal fade" id="editGuruModal-{{ $prestasi->id }}"
                                                tabindex="-1"
                                                aria-labelledby="editGuruModalLabel-{{ $prestasi->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="POST"
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editGuruModalLabel-{{ $prestasi->id }}">Edit
                                                                    Prestasi</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                {{-- <div class="form-group">
                                                                    ...
                                                                    <textarea id="biography" class="form-control" name="biography" required>{{ $prestasi->biography }}</textarea>
                                                                </div> --}}
                                                            </div>
                                                            <div class="modal-footer">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center">Tidak ada data prestasi
                                                    tersedia
                                                </td>
                                            </tr>
                                        @endforelse
