                                ...
                                <table class="table" id="table2">
                                    ...
                                    <tbody>
                                        @forelse($teachers as $index => $teacher)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($teacher->photo)
                                                        ...
                                                        <button type="button" class="btn btn-outline-success btn-sm"
                                                            ...
                                                            data-bs-target="#photoModal{{ $teacher->id }}">
                                                            View Photo
                                                        </button>

                                                        <!-- Photo Modal -->
                                                        <div class="modal fade" id="photoModal{{ $teacher->id }}"
                                                            tabindex="-1"
                                                            aria-labelledby="photoModalLabel{{ $teacher->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="photoModalLabel{{ $teacher->id }}">
                                                                            Teacher Photo
                                                                        </h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <img src="{{ asset('storage/guru/' . $teacher->photo) }}"
                                                                            alt="Teacher Photo" class="img-fluid">
                                                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editGuruModal-{{ $teacher->id }}">
                                                        Edit
                                                    </button>
                                            ...
                                            <!-- Edit Guru Modal -->
                                            <div class="modal fade" id="editGuruModal-{{ $teacher->id }}"
                                                tabindex="-1"
                                                aria-labelledby="editGuruModalLabel-{{ $teacher->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="POST"
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editGuruModalLabel-{{ $teacher->id }}">Edit
                                                                    Guru</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center">Tidak ada data guru tersedia
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                        ...
                        <div class="modal-content">
                            <form method="POST" action="{{ route('teachers.store') }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="designation">Mapel</label>
