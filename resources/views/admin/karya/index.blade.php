...
<head>
    ...
    <title>Daftar Karya dan Aktivitas - UPTD SPF SDN Nangkaan Admin</title>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Daftar Karya dan Aktivitas</h3>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Daftar Karya dan Aktivitas
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                Tabel Daftar Karya dan Aktivitas
                            </h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse($karyas as $index => $karya)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($karya->photo_path)
                                                        ...
                                                        <button type="button" class="btn btn-outline-success btn-sm"
                                                            ...
                                                            data-bs-target="#photoModal{{ $karya->id }}">
                                                            View Photo
                                                        </button>

                                                        <!-- Photo Modal -->
                                                        <div class="modal fade" id="photoModal{{ $karya->id }}"
                                                            tabindex="-1"
                                                            aria-labelledby="photoModalLabel{{ $karya->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="photoModalLabel{{ $karya->id }}">
                                                                            Foto Karya dan Aktivitas Photo
                                                                        </h5>
                                                ...
                                                {{-- <td>{{ $karya->biography }}</td> --}}
                                                <td>
                                                    <!-- Edit and Delete Buttons -->
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editGuruModal-{{ $karya->id }}">
                                                        Edit
                                                    </button>
                                                    <form action="{{ route('karya.destroy', $karya->id) }}"
                                            ...
                                            <!-- Edit Guru Modal -->
                                            <div class="modal fade" id="editGuruModal-{{ $karya->id }}"
                                                tabindex="-1"
                                                aria-labelledby="editGuruModalLabel-{{ $karya->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="POST"
                                                            action="{{ route('karya.update', $karya->id) }}"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editGuruModalLabel-{{ $karya->id }}">Edit
                                                                    Karya dan Aktivitas</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="photo_path"
                                                                        class="form-control" name="photo_path">
                                                                    @if ($karya->photo_path)
                                                                ...
                                                                {{-- <div class="form-group">
                                                                    ...
                                                                    <textarea id="biography" class="form-control" name="biography" required>{{ $karya->biography }}</textarea>
                                                                </div> --}}
                                                            </div>
                                                            <div class="modal-footer">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center">Tidak ada data karya dan
                                                    aktivitas tersedia
                                                </td>
                                            </tr>
                                        @endforelse
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('karya.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title">Tambah Karya dan Aktivitas Baru</h5>
